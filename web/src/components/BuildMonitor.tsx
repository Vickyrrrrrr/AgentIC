...
const STATES_DISPLAY: Record<string, { label: string; icon: string }> = {
    ...
    VERIFICATION_PLAN: { label: 'Verification Planning', icon: '05' },
    RTL_GEN: { label: 'RTL Generation', icon: '06' },
    RTL_FIX: { label: 'RTL Syntax Fixing', icon: '07' },
    LINT_CHECK: { label: 'RTL Lint Check', icon: '08' },
    ...
    FEASIBILITY_CHECK: { label: 'Feasibility Check', icon: '16' },
    DFT_SCAN: { label: 'DFT Scan Insertion', icon: '17' },
    DFT_ATPG: { label: 'DFT ATPG Patterns', icon: '18' },
    MBIST: { label: 'Memory BIST', icon: '19' },
    GLS_SIM: { label: 'Gate-Level Simulation', icon: '20' },
    FLOORPLAN: { label: 'Floorplanning', icon: '21' },
    HARDENING: { label: 'GDSII Hardening', icon: '22' },
    TIMING_ANALYSIS: { label: 'Static Timing Analysis', icon: '23' },
    CONVERGENCE_REVIEW: { label: 'Convergence Review', icon: '24' },
